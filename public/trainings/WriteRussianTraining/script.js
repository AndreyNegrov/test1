WriteRussianTraining = function (finishTrainingCallback) {
    Training.call(this, finishTrainingCallback);

    this.trainingName = 'WriteRussianTraining';
    this.iteration = WriteRussianTrainingIteration;
...
const WriteRussianTrainingIteration = function (item, dom, finishIterationCallable) {
    ...
    this.fillDOM = () => {
        ...
        DOMModifier.setMiddleSection(this.item.english);
    ...
    this.validationAnswer = (litter, button) => {
        ...
        if (result !== this.item.word) {
            this.causeError();
            this.DOM.rightWordDOM.innerHTML = this.item.word;
    ...
    this.setIterationToEnd = () => {
        ...
        this.DOM.answerContainerDOM.innerHTML = this.item.word;
    };
