WriteEnglishTraining = function (finishTrainingCallback) {
    Training.call(this, finishTrainingCallback);

    this.trainingName = 'WriteEnglishTraining';
    this.iteration = WriteEnglishTrainingIteration;
...
const WriteEnglishTrainingIteration = function (item, dom, finishIterationCallable) {
