WordTranslateTraining = function (finishTrainingCallback) {

    Training.call(this, finishTrainingCallback);

    this.trainingName = 'WordTranslateTraining';
    this.iteration = WordTranslateIteration;
...
const WordTranslateIteration = function (item, dom, finishIterationCallable) {
