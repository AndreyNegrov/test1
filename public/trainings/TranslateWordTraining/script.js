TranslateWordTraining = function (finishTrainingCallback) {

    Training.call(this, finishTrainingCallback);

    this.trainingName = 'TranslateWordTraining';
    this.iteration = TranslateWordIteration;
...
const TranslateWordIteration = function (item, dom, finishIterationCallable) {
    TrainingIteration.call(this, item, dom, finishIterationCallable);

    this.fillDOM = () => {
        DOMModifier.setHighSection(this.item.word);
