ContextTraining = function (finishTrainingCallback) {
    Training.call(this, finishTrainingCallback);

    this.trainingName = 'ContextTraining';

    this.iteration = ContextIteration;
...
const ContextIteration = function (item, dom, finishIterationCallable) {
