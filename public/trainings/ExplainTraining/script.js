ExplainTraining = function (finishTrainingCallback) {

    Training.call(this, finishTrainingCallback);

    this.trainingName = 'ExplainTraining';
    this.iteration = ExplainIteration;
...
const ExplainIteration = function (item, dom, finishIterationCallable) {
    TrainingIteration.call(this, item, dom, finishIterationCallable);

    this.fillDOM = () => {
        DOMModifier.setHighSection(this.item.additionInfo.explain);
