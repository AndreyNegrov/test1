ListeningTraining = function (finishTrainingCallback) {
    Training.call(this, finishTrainingCallback);

    this.trainingName = 'ListeningTraining';
    this.iteration = ListeningTrainingIteration;
...
const ListeningTrainingIteration = function (item, dom, finishIterationCallable) {
