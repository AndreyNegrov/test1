ListeningContextTraining = function (finishTrainingCallback) {
    Training.call(this, finishTrainingCallback);

    this.trainingName = 'ListeningContextTraining';

    this.iteration = ListeningContextTrainingIteration;
...
const ListeningContextTrainingIteration = function (item, dom, finishIterationCallable) {
