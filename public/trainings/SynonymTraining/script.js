SynonymTraining = function (finishTrainingCallback) {

    Training.call(this, finishTrainingCallback);

    this.trainingName = 'SynonymTraining';
    this.iteration = SynonymTrainingIteration;
...
const SynonymTrainingIteration = function (item, dom, finishIterationCallable) {
    TrainingIteration.call(this, item, dom, finishIterationCallable);

    this.fillDOM = () => {
        DOMModifier.setHighSection(this.item.additionInfo['english-synonyms'].join(', '));
