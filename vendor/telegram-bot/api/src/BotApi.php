...
class BotApi
{
    ...
    public function call($method, array $data = null)
    {
        ...
        file_put_contents('qwwqq.json', json_encode($response));
 ...
 */
public
function answerCallbackQuery($callbackQueryId, $text = null, $showAlert = false, $uri)
{
 ...
 */
public
function trackUpdate(Update $update, $eventName = 'Message')
{
 ...
 */
public
function track(Message $message, $eventName = 'Message')
{
    if ($this->tracker instanceof Botan) {
 ...
 */
public
function answerShippingQuery($shippingQueryId, $ok = true, $shipping_options = [], $errorMessage = null)
{
 ...
 */
public
function setChatDescription($chatId, $description = null)
{
 ...
 */
public
function unsetCurlOption($option)
{
